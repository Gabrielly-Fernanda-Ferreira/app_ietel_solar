...
class ListaVagasAdmPage extends StatelessWidget {
  ...
  void _telaEditaVagas(BuildContext context, id, cargo, tipo, local, modelo, descricao) {
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  void _excluirVaga(String idVaga) async {
    await firestore.collection('vagas').doc(idVaga).delete();
  }
              ...
              Column(
                children: [
                  StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                    stream: firestore.collection('vagas').orderBy('cargo').snapshots(),
                            ...
                            Column(
                              ...
                              children: docs.map(
                                (doc) => Padding(
                                  ...
                                  child: InkWell(
                                    onTap: () => _telaListaCandidatos(context, doc.id),
                                    child: Container(
